...
import { Base_url } from '@api/config'; // Your Base URL for API calls
...
import NoDataState from '@components/ui/NoData.jsx';
import { memberStyles } from './Sheduledshifts-styles';

// Add styles to document
const styleSheet = document.createElement("style");
styleSheet.innerText = memberStyles;
